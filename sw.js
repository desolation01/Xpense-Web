...
const SW_CACHE_REVISION = "vault-ui-58";
...
const APP_SHELL = [
  ...
  "/css/tokens.css",
  "/css/styles.css",
  "/css/styles.css?v=2.1.1",
  "/css/tracker.css",
  "/css/tracker.css?v=2.4.4",
  "/css/landing.css",
  "/css/pwa.css",
  "/js/localDataStore.js",
  "/js/localDataStore.js?v=1.0.10",
  "/js/privateVault.js",
  "/js/privateVault.js?v=1.0.30",
  "/js/tracker.js",
  "/js/tracker.js?v=1.4.34",
  "/assets/icons/accounts/gcash.svg",
  "/assets/icons/accounts/maya.svg",
  "/assets/icons/accounts/gotyme.svg",
  "/assets/icons/accounts/bdo.svg",
  "/assets/icons/accounts/bpi.svg",
  "/assets/icons/accounts/metrobank.svg",
  "/assets/icons/accounts/landbank.svg",
  "/assets/icons/accounts/maribank.svg",
  "/assets/icons/accounts/unionbank.svg",
  "/assets/icons/accounts/security-bank.svg",
  "/assets/icons/accounts/eastwest-bank.svg",
  "/js/tracker-auth-page.js",
  "/js/tracker-auth-page.js?v=1.0.14",
  "/js/pwa.js",
  "/js/pwa.js?v=1.2.1",
  "/assets/hehehe.png",
  "/assets/hero-mockup.png",
  "/assets/qr/xpense-share-qr.png",
...
self.addEventListener("fetch", (event) => {
  ...
  if (
    ...
    url.searchParams.get("action") === "public_stats"
  ) {
