...
const SW_CACHE_REVISION = "vault-ui-22";
...
const APP_SHELL = [
  ...
  "/css/tokens.css",
  "/css/styles.css",
  "/css/styles.css?v=2.0.3",
  "/css/tracker.css",
  "/css/tracker.css?v=2.2.6",
  "/css/landing.css",
  "/css/pwa.css",
  "/js/localDataStore.js",
  "/js/localDataStore.js?v=1.0.2",
  "/js/privateVault.js",
  "/js/privateVault.js?v=1.0.15",
  "/js/tracker.js",
  "/js/tracker.js?v=1.4.22",
  ...
  "/js/tracker-auth-page.js?v=1.0.6",
  "/js/chat.js",
  "/js/chat.js?v=1.3.2",
  "/js/pwa.js",
  "/js/pwa.js?v=1.1.2",
